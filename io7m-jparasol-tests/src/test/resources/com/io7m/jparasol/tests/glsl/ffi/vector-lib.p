...
module M is
  ...
  type t is record
    ...
    v2f_divide          : vector_2f,
    v2f_divide_scalar   : vector_2f,
    v2f_dot             : float,
    v2f_interpolate     : vector_2f,
    v2f_magnitude       : float,
    v2f_minimum         : vector_2f,
    v2f_maximum         : vector_2f,
    ...
    v2f_subtract_scalar : vector_2f,

    v2i_add             : vector_2i,
    v2i_add_scalar      : vector_2i,
    v2i_divide          : vector_2i,
    v2i_divide_scalar   : vector_2i,
    v2i_dot             : float,
    v2i_interpolate     : vector_2i,
    v2i_magnitude       : float,
    v2i_minimum         : vector_2i,
    v2i_maximum         : vector_2i,
    ...
    v2i_subtract_scalar : vector_2i,

    v3f_add             : vector_3f,
    v3f_add_scalar      : vector_3f,
    v3f_cross           : vector_3f,
    v3f_divide          : vector_3f,
    v3f_divide_scalar   : vector_3f,
    v3f_dot             : float,
    v3f_interpolate     : vector_3f,
    v3f_magnitude       : float,
    v3f_minimum         : vector_3f,
    v3f_maximum         : vector_3f,
    ...
    v3f_subtract_scalar : vector_3f,

    v3i_add             : vector_3i,
    v3i_add_scalar      : vector_3i,
    v3i_divide          : vector_3i,
    v3i_divide_scalar   : vector_3i,
    v3i_dot             : float,
    v3i_interpolate     : vector_3i,
    v3i_magnitude       : float,
    v3i_minimum         : vector_3i,
    v3i_maximum         : vector_3i,
    ...
    v3i_subtract_scalar : vector_3i,

    v4f_add             : vector_4f,
    v4f_add_scalar      : vector_4f,
    v4f_divide          : vector_4f,
    v4f_divide_scalar   : vector_4f,
    v4f_dot             : float,
    v4f_interpolate     : vector_4f,
    v4f_magnitude       : float,
    v4f_minimum         : vector_4f,
    v4f_maximum         : vector_4f,
    ...
    v4f_subtract_scalar : vector_4f,

    v4i_add             : vector_4i,
    v4i_add_scalar      : vector_4i,
    v4i_divide          : vector_4i,
    v4i_divide_scalar   : vector_4i,
    v4i_dot             : float,
    v4i_interpolate     : vector_4i,
    v4i_magnitude       : float,
    v4i_minimum         : vector_4i,
    v4i_maximum         : vector_4i,
  ...
  function make (x : float, n : integer) : t =
    record t {
      ...
      v2f_divide          = V2F.divide (new vector_2f (x, x), new vector_2f (x, x)),
      v2f_divide_scalar   = V2F.divide_scalar (new vector_2f (x, x), x),
      ...
      v2f_minimum         = V2F.minimum (new vector_2f (x, x), new vector_2f (x, x)),
      v2f_maximum         = V2F.maximum (new vector_2f (x, x), new vector_2f (x, x)),
      v2f_multiply        = V2F.multiply (new vector_2f (x, x), new vector_2f (x, x)),
      v2f_multiply_scalar = V2F.multiply_scalar (new vector_2f (x, x), x),
      ...
      v2f_subtract_scalar = V2F.subtract_scalar (new vector_2f (x, x), x),

      v2i_add             = V2I.add (new vector_2i (n, n), new vector_2i (n, n)),
      v2i_add_scalar      = V2I.add_scalar (new vector_2i (n, n), n),
      v2i_divide          = V2I.divide (new vector_2i (n, n), new vector_2i (n, n)),
      v2i_divide_scalar   = V2I.divide_scalar (new vector_2i (n, n), n),
      ...
      v2i_minimum         = V2I.minimum (new vector_2i (n, n), new vector_2i (n, n)),
      v2i_maximum         = V2I.maximum (new vector_2i (n, n), new vector_2i (n, n)),
      v2i_multiply        = V2I.multiply (new vector_2i (n, n), new vector_2i (n, n)),
      v2i_multiply_scalar = V2I.multiply_scalar (new vector_2i (n, n), n),
      ...
      v2i_subtract_scalar = V2I.subtract_scalar (new vector_2i (n, n), n),
      ...
      v3f_divide          = V3F.divide (new vector_3f (x, x, x), new vector_3f (x, x, x)),
      v3f_divide_scalar   = V3F.divide_scalar (new vector_3f (x, x, x), x),
      ...
      v3f_minimum         = V3F.minimum (new vector_3f (x, x, x), new vector_3f (x, x, x)),
      v3f_maximum         = V3F.maximum (new vector_3f (x, x, x), new vector_3f (x, x, x)),
      v3f_multiply        = V3F.multiply (new vector_3f (x, x, x), new vector_3f (x, x, x)),
      v3f_multiply_scalar = V3F.multiply_scalar (new vector_3f (x, x, x), x),
      ...
      v3f_subtract_scalar = V3F.subtract_scalar (new vector_3f (x, x, x), x),

      v3i_add             = V3I.add (new vector_3i (n, n, n), new vector_3i (n, n, n)),
      v3i_add_scalar      = V3I.add_scalar (new vector_3i (n, n, n), n),
      v3i_divide          = V3I.divide (new vector_3i (n, n, n), new vector_3i (n, n, n)),
      v3i_divide_scalar   = V3I.divide_scalar (new vector_3i (n, n, n), n),
      ...
      v3i_minimum         = V3I.minimum (new vector_3i (n, n, n), new vector_3i (n, n, n)),
      v3i_maximum         = V3I.maximum (new vector_3i (n, n, n), new vector_3i (n, n, n)),
      v3i_multiply        = V3I.multiply (new vector_3i (n, n, n), new vector_3i (n, n, n)),
      v3i_multiply_scalar = V3I.multiply_scalar (new vector_3i (n, n, n), n),
      ...
      v3i_subtract_scalar = V3I.subtract_scalar (new vector_3i (n, n, n), n),

      v4f_add             = V4F.add (new vector_4f (x, x, x, x), new vector_4f (x, x, x, x)),
      v4f_add_scalar      = V4F.add_scalar (new vector_4f (x, x, x, x), x),
      v4f_divide          = V4F.divide (new vector_4f (x, x, x, x), new vector_4f (x, x, x, x)),
      v4f_divide_scalar   = V4F.divide_scalar (new vector_4f (x, x, x, x), x),
      ...
      v4f_minimum         = V4F.minimum (new vector_4f (x, x, x, x), new vector_4f (x, x, x, x)),
      v4f_maximum         = V4F.maximum (new vector_4f (x, x, x, x), new vector_4f (x, x, x, x)),
      v4f_multiply        = V4F.multiply (new vector_4f (x, x, x, x), new vector_4f (x, x, x, x)),
      v4f_multiply_scalar = V4F.multiply_scalar (new vector_4f (x, x, x, x), x),
      ...
      v4f_subtract_scalar = V4F.subtract_scalar (new vector_4f (x, x, x, x), x),

      v4i_add             = V4I.add (new vector_4i (n, n, n, n), new vector_4i (n, n, n, n)),
      v4i_add_scalar      = V4I.add_scalar (new vector_4i (n, n, n, n), n),
      v4i_divide          = V4I.divide (new vector_4i (n, n, n, n), new vector_4i (n, n, n, n)),
      v4i_divide_scalar   = V4I.divide_scalar (new vector_4i (n, n, n, n), n),
      ...
      v4i_minimum         = V4I.minimum (new vector_4i (n, n, n, n), new vector_4i (n, n, n, n)),
      v4i_maximum         = V4I.maximum (new vector_4i (n, n, n, n), new vector_4i (n, n, n, n)),
      v4i_multiply        = V4I.multiply (new vector_4i (n, n, n, n), new vector_4i (n, n, n, n)),
      v4i_multiply_scalar = V4I.multiply_scalar (new vector_4i (n, n, n, n), n),
      ...
      v4i_subtract_scalar = V4I.subtract_scalar (new vector_4i (n, n, n, n), n)
    };
